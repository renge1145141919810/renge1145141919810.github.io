...
拿到题目附件，查看一下保护
![image](/images/pwn-lit-ropchain/img_1.png)
...
![image](/images/pwn-lit-ropchain/img_2.png)

放到ida里面还能看见程序里面已经准备了system函数，但是**没有“/bin/sh”字符串**

![image](/images/pwn-lit-ropchain/img_3.png)
...
```
发送即可拿到shell
![image](/images/pwn-lit-ropchain/img_4.png)
